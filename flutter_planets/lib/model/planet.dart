...
List<Planet> planets = [
  const Planet(
      ...
      picture:
          "https://ichef.bbci.co.uk/news/640/cpsprodpb/14A79/production/_117010648_untitled.png"),
  const Planet(
      id: "2",
      name: "Neptune",
      location: "Milkyway Galaxy",
      ...
      picture:
          "https://upload.wikimedia.org/wikipedia/commons/thumb/6/63/Neptune_-_Voyager_2_%2829347980845%29_flatten_crop.jpg/240px-Neptune_-_Voyager_2_%2829347980845%29_flatten_crop.jpg"),
  const Planet(
      id: "3",
      name: "Moon",
      location: "Milkyway Galaxy",
  ...
  const Planet(
      ...
      picture:
          "https://imgresizer.eurosport.com/unsafe/1200x0/filters:format(jpeg):focal(1298x715:1300x713)/origin-imgresizer.eurosport.com/2019/07/08/2634898-54520570-2560-1440.jpg"),
  const Planet(
      id: "5",
      name: "Mercury",
      location: "Milkyway Galaxy",
